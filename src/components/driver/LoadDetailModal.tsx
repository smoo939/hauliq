              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm font-medium">{load.pickup_location}</p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">Delivery</p>
                    <p className="text-sm font-medium">{load.delivery_location}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {showBidForm && (
              <div className="bg-muted rounded-xl p-4 space-y-3">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => setShowBidForm(false)} className="flex-1">
                    Cancel
                  </Button>
                  <Button size="sm" onClick={handleBid} disabled={submitting || !bidAmount} className="flex-1">
