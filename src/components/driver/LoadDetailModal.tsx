...
import { MapPin, Package, Clock, DollarSign, Truck, MessageCircle, Gavel, CheckCircle, Flame } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="border-t border-border p-4 bg-card space-y-2">
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={() => setShowBidForm(!showBidForm)} className="flex-1 h-12 text-sm font-bold">
